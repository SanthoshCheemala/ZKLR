...
contract PlonkVerifier {
  ...
  uint256 private constant G2_SRS_1_X_0 = 21326641407486608790084434235594896019177767583878156524572073552541595079469;
  uint256 private constant G2_SRS_1_X_1 = 12585731532319196919574993343904331969727690050965990510788944100211967153890;
  uint256 private constant G2_SRS_1_Y_0 = 561017496286163410126496465030976708880858329825909763434857594720603102510;
  uint256 private constant G2_SRS_1_Y_1 = 20825105107028384708702120768211494607403762527585949740710378622328410627471;
  
  uint256 private constant G1_SRS_X = 1;
  uint256 private constant G1_SRS_Y = 2;

  // ----------------------- vk ---------------------
  uint256 private constant VK_NB_PUBLIC_INPUTS = 241;
  ...
  uint256 private constant VK_QL_COM_X = 18859971817108055843385734175207270525676089191472124140878926279931306616499;
  uint256 private constant VK_QL_COM_Y = 4302149566868766574672027271841181067923048231693346799871863537391472105065;
  uint256 private constant VK_QR_COM_X = 21448100601653984257909054204774874033165014195180679671221956462363582123218;
  uint256 private constant VK_QR_COM_Y = 16269809950935357120320767162978191614976773875285153893704487998980845509411;
  uint256 private constant VK_QM_COM_X = 2911131117796004746124192250150682970672391142159671036400948777545910496323;
  uint256 private constant VK_QM_COM_Y = 11876631384321982173460873876366123827835164046742607544514047082555335939348;
  uint256 private constant VK_QO_COM_X = 12951578152077967537882218281345223582111631883669572579262564819910621204492;
  uint256 private constant VK_QO_COM_Y = 14393365552752519798823321328617986195347134985932091665405148307629441626097;
  uint256 private constant VK_QK_COM_X = 9526284986048299438223352736746297420510044209184701460695400308751065582906;
  uint256 private constant VK_QK_COM_Y = 17826208698301072768186810889104002231315983549333269031330364177834308984542;
  
  uint256 private constant VK_S1_COM_X = 2600812405493891208106665094972490654052225998409392105436610632881636722145;
  uint256 private constant VK_S1_COM_Y = 12503506285171995718460317804681650450135173639794552210042328081119279933083;
  
  uint256 private constant VK_S2_COM_X = 9069251486087700908824451690788193474472091500555537581473412479244043430634;
  uint256 private constant VK_S2_COM_Y = 13489552319880748411734182255542927170173547064871965669986291495923574039962;
  
  uint256 private constant VK_S3_COM_X = 14630371208363144265708343871220696257807651392992698236597165096225152899724;
  uint256 private constant VK_S3_COM_Y = 8991060057011137971096489423343724021504314736861069778103442448197077073145;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 16048266728755093267271882920685586462708790428030104893405505680178183902033;
  uint256 private constant VK_QCP_0_Y = 3170690928413794637421771694571766341099928130901209009066935638497860043103;
  
  
  uint256 private constant VK_INDEX_COMMIT_API_0 = 146142;
