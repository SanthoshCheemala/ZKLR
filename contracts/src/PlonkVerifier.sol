...
contract PlonkVerifier {
  ...
  uint256 private constant G2_SRS_1_X_0 = 6893695116467239905434553459083459517288413449139367905275681768568050056384;
  uint256 private constant G2_SRS_1_X_1 = 2524662656997085275840333304343975750228265936615650809797259426084439929794;
  uint256 private constant G2_SRS_1_Y_0 = 11907135487438981656518352808894031504201299347662817099608776155133547807336;
  uint256 private constant G2_SRS_1_Y_1 = 19567304990958181325462769259563610912292746096758554120317684091420214109922;
  
  uint256 private constant G1_SRS_X = 1;
  uint256 private constant G1_SRS_Y = 2;

  // ----------------------- vk ---------------------
  uint256 private constant VK_NB_PUBLIC_INPUTS = 26;
  uint256 private constant VK_DOMAIN_SIZE = 262144;
  uint256 private constant VK_INV_DOMAIN_SIZE = 21888159374819042681065900960079108671330771976540605510559380874944847741953;
  uint256 private constant VK_OMEGA = 11699596668367776675346610687704220591435078791727316319397053191800576917728;
  uint256 private constant VK_QL_COM_X = 17294547342496149311797799320747219022816414857971870570982517820727560066751;
  uint256 private constant VK_QL_COM_Y = 21781431867657331306224275639795984135579774507166703852617336724724383909820;
  uint256 private constant VK_QR_COM_X = 893336989043785512592632280274339164350931072699930599573459303090937569919;
  uint256 private constant VK_QR_COM_Y = 18406781302214474047251211575539518347929766165824567946816488638004558070779;
  uint256 private constant VK_QM_COM_X = 5162967507113971650198253909347664300479819595764566260452987962400047609348;
  uint256 private constant VK_QM_COM_Y = 11475053075849375050834988059359329395134802590442412067041403244459564027844;
  uint256 private constant VK_QO_COM_X = 13532651632003712592971346689811807386090349254402467237243412656333816016174;
  uint256 private constant VK_QO_COM_Y = 13103903050586926763217762463322228953347292501113837134213856875320679815180;
  uint256 private constant VK_QK_COM_X = 20762549232694444810614040963738316709984624510899867633333280954473828978598;
  uint256 private constant VK_QK_COM_Y = 20778804954754746033303664399753553109783826466476006924326394342687113837109;
  
  uint256 private constant VK_S1_COM_X = 13381620426300785277226555552180951583743266689401853272242164582096685011000;
  uint256 private constant VK_S1_COM_Y = 17343169293615151668037047844461953671135847906729853337939875968789524809547;
  
  uint256 private constant VK_S2_COM_X = 18909990408005244518818114432894047925217580175826651256242734981339655681800;
  uint256 private constant VK_S2_COM_Y = 8355860583611448743036864220325643063966996827544472973829693259376905407836;
  
  uint256 private constant VK_S3_COM_X = 21594521516878403523748635191398503658503429024844545933403559468766038046584;
  uint256 private constant VK_S3_COM_Y = 10052789919892852866823679722275991332839010059416992961367128287633625815667;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 13684273805692250013445478644727295139885795161525452149353475539951430599284;
  uint256 private constant VK_QCP_0_Y = 3153290333187966797630348134774222081025375583992829641313600528767355649565;
  
  
  uint256 private constant VK_INDEX_COMMIT_API_0 = 77740;
