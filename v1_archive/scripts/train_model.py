...
def main():
    ...
    # Pre-scaled integer values for Go ZK circuit (multiply by 2^32)
    scale = 2**32
    print(f"Pre-scaled integer values for Go ZK circuit:")
    print(f"  W_SCALED = {round(coef * scale)}")
    print(f"  B_SCALED = {round(intercept * scale)}")
    print()
